...
import 'package:shusruta_lms/modules/hardcopyNotes/selected_subscription_confirm_purchase_bottom_sheet.dart';
...
/// Address selection for combined subscription + hardcopy purchase — redesigned
/// with AppTokens. Full constructor contract (11 fields), static route
/// argument contract, SubscriptionStore Provider wiring, and the
/// ConfirmSubscriptionAndHardCopyPurchaseBottomSheet launch are preserved.
class HardCopyAndSubscriptionAddressDetailScreen extends StatefulWidget {
  ...
  const HardCopyAndSubscriptionAddressDetailScreen({
    super.key,
  ...
  @override
  State<HardCopyAndSubscriptionAddressDetailScreen> createState() =>
      _HardCopyAndSubscriptionAddressDetailScreenState();

  static Route<dynamic> route(RouteSettings routeSettings) {
    final arguments = routeSettings.arguments as Map<String, dynamic>;
    return CupertinoPageRoute(
      builder: (_) => HardCopyAndSubscriptionAddressDetailScreen(
...
class _HardCopyAndSubscriptionAddressDetailScreenState
    extends State<HardCopyAndSubscriptionAddressDetailScreen> {
  int currentIndex = 0;
  ...
  Future<void> _openPurchaseConfirmation(
      BuildContext context, SubscriptionStore store) async {
    await showModalBottomSheet<void>(
      isScrollControlled: true,
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
      ...
      context: context,
      builder: (BuildContext context) {
        return ConfirmSubscriptionAndHardCopyPurchaseBottomSheet(
      ...
      body: Column(
        children: [
          _Header(
            ...
            onAdd: () async => _openAddressSheet(context, null),
          ),
          Expanded(
                  ...
                  children: [
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return _AddressCard(
                            ...
                            onEdit: () async {
                              setState(() => currentIndex = index);
                              await _openAddressSheet(context, address);
                            },
                          );
                        },
                      ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () => _openPurchaseConfirmation(
                          context,
                          store,
                        ),
