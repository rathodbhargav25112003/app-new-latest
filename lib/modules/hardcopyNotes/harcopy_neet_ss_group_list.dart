...
/// NEET SS subscription group list for hardcopy bundle flow — redesigned with
/// AppTokens. Constructor, static route, TabController + SingleTicker mixin,
/// MobX Observer, SubscriptionStore & LoginStore Provider wiring,
/// SharedPreferences login check, and all navigation targets preserved.
class NeetGroupSubscriptionListWithHardCopy extends StatefulWidget {
  const NeetGroupSubscriptionListWithHardCopy({super.key});

  @override
  State<NeetGroupSubscriptionListWithHardCopy> createState() =>
      _NeetGroupSubscriptionListWithHardCopyState();

  static Route<dynamic> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => const NeetGroupSubscriptionListWithHardCopy(),
    );
  }
}

class _NeetGroupSubscriptionListWithHardCopyState
    extends State<NeetGroupSubscriptionListWithHardCopy>
