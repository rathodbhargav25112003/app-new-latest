...
/// CustomTopicBottomSheetWindow — desktop / tablet counterpart of the
/// topic filter sheet. Public surface preserved exactly:
...
class CustomTopicBottomSheetWindow extends StatefulWidget {
  final List<String>? radioItems;
  final VideoCategoryStore? store;
  final double? heightSize;
  final String selectedVal;
  const CustomTopicBottomSheetWindow({
    super.key,
  ...
  @override
  State<CustomTopicBottomSheetWindow> createState() =>
      _CustomTopicBottomSheetWindowState();
}

class _CustomTopicBottomSheetWindowState
    extends State<CustomTopicBottomSheetWindow> {
