...
/// Windowed desktop counterparts to the mobile raise-query sheets.
/// Public surface preserved exactly:
///   • [CustomBottomRaiseQueryWindow] const named constructor with
///     `questionId` (required), `questionText`, `allOptions`
///   • [CustomBottomAskFacultyWindow] const named constructor with
///     `questionId` / `questionText` / `allOptions` (all required), its
///     state behaviour (`settingsData`, `_getUserDetails`, `_launchWhatsApp`
///     with 91-prefixed wa.me path)
///   • [CustomBottomReportIssueWindow] const named constructor with the
///     same three required fields, all 10 `valueN` bool flags, `addQuery`
///     call to `ReportsCategoryStore.onCreateQuerySolutionReport`
class CustomBottomRaiseQueryWindow extends StatefulWidget {
  final String questionId;
  final String? questionText;
  final String? allOptions;
  const CustomBottomRaiseQueryWindow({
    super.key,
  ...
  @override
  State<CustomBottomRaiseQueryWindow> createState() =>
      _CustomBottomRaiseQueryWindowState();
}

class _CustomBottomRaiseQueryWindowState
    extends State<CustomBottomRaiseQueryWindow> {
  // ignore: unused_field
  ...
  void _openAskFaculty() {
    ...
    showDialog(
      context: context,
      builder: (_) => _DesktopCardDialog(
        child: CustomBottomAskFacultyWindow(
  ...
  void _openReport() {
    ...
    showDialog(
      context: context,
      builder: (_) => _DesktopCardDialog(
        child: CustomBottomReportIssueWindow(
          questionId: widget.questionId,
          questionText: widget.questionText ?? '',
          allOptions: widget.allOptions ?? '',
        ),
...
// ---------------------------------------------------------------------------
// CustomBottomAskFacultyWindow
// ---------------------------------------------------------------------------

class CustomBottomAskFacultyWindow extends StatefulWidget {
  final String questionId;
  final String questionText;
  final String allOptions;
  const CustomBottomAskFacultyWindow({
    super.key,
    required this.questionId,
  ...
  @override
  State<CustomBottomAskFacultyWindow> createState() =>
      _CustomBottomAskFacultyWindowState();
}

class _CustomBottomAskFacultyWindowState
    extends State<CustomBottomAskFacultyWindow> {
  ...
  // Preserved helper — 91-prefixed wa.me contract.
...
// ---------------------------------------------------------------------------
// CustomBottomReportIssueWindow
// ---------------------------------------------------------------------------

class CustomBottomReportIssueWindow extends StatefulWidget {
  final String questionId;
  final String questionText;
  final String allOptions;
  const CustomBottomReportIssueWindow({
    super.key,
    required this.questionId,
    required this.questionText,
    required this.allOptions,
  ...
  @override
  State<CustomBottomReportIssueWindow> createState() =>
      _CustomBottomReportIssueWindowState();
}

class _CustomBottomReportIssueWindowState
    extends State<CustomBottomReportIssueWindow> {
  TextEditingController queryController = TextEditingController();
  bool value1 = false;
  bool value2 = false;
  bool value3 = false;
...
class _DesktopCardDialog extends StatelessWidget {
  const _DesktopCardDialog({required this.child});
...
// Keep legacy color API reachable.
