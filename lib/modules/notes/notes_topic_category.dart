...
class NotesTopicCategoryScreen extends StatefulWidget {
  ...
  const NotesTopicCategoryScreen(
      {super.key, required this.subject, required this.notesid, required this.topicname});

  @override
  State<NotesTopicCategoryScreen> createState() => _NotesTopicCategoryScreenState();
...
class _NotesTopicCategoryScreenState extends State<NotesTopicCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //           ),
        //           Text(
        //             "${store.notestopiccategory.length.toString().padLeft(2,'0')} Topics",
        //             style: interRegular.copyWith(
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              //             color: ThemeManager.videoSubjectContainer.withOpacity(0.3),
              //             borderRadius: BorderRadius.circular(9.61)),
              //         child: SvgPicture.asset("assets/image/notetopic2.svg"),
              //       ),
              //       const SizedBox(
              ...
              //             return Text(
              //               store.notestopiccategory.length
              //                 .toString()
              //                 .padLeft(2, '0'),
              //               style: interRegular.copyWith(
                        ...
                        child: Observer(
                          builder: (BuildContext context) {
                            ...
                            if (selectedFilter == "All") {
                              ...
                              filteredNotes = store.notestopiccategory.where((note) {
  ...
  Widget buildItem(BuildContext context, GlobalSearchDataModel? searchDataModel) {
    // SearchedDataModel? noteSubcat = searchDataModel;
  ...
  Widget buildItem1(BuildContext context, NotesTopicCategoryModel? notesTopicCategoryModel,
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            (notesSubcategory?.topicName != null)
                                ? Text(
