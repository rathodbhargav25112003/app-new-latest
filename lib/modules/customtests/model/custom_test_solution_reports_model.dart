...
part 'custom_test_solution_reports_model.g.dart';

@JsonSerializable(explicitToJson: true)
class CustomTestSolutionReportsModel {
  CustomTestSolutionReportsModel({
    this.isCorrect,
    this.bookmarks,
    this.selectedOption,
    this.questionImg,
  ...
  factory CustomTestSolutionReportsModel.fromJson(Map<String, dynamic> json) => _$CustomTestSolutionReportsModelFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$CustomTestSolutionReportsModelToJson(this);
}
