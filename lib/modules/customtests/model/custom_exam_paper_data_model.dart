...
part 'custom_exam_paper_data_model.g.dart';

@JsonSerializable(explicitToJson: true)
class CustomExamPaperDataModel {
  CustomExamPaperDataModel({
    this.questionImg,
    this.explanationImg,
    this.sId,
    this.examId,
  ...
  factory CustomExamPaperDataModel.fromJson(Map<String, dynamic> json) => _$CustomExamPaperDataModelFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$CustomExamPaperDataModelToJson(this);
}
