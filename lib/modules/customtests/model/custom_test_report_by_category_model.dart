...
part 'custom_test_report_by_category_model.g.dart';

@JsonSerializable(explicitToJson: true)
class CustomTestReportByCategoryModel {
  CustomTestReportByCategoryModel({
    this.categoryName,
    this.userRank,
    this.userFirstRank,
    this.myMark,
  ...
  factory CustomTestReportByCategoryModel.fromJson(Map<String, dynamic> json) => _$CustomTestReportByCategoryModelFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$CustomTestReportByCategoryModelToJson(this);
}
