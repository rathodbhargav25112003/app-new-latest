...
part 'quiz_exam_answer_model.g.dart';

@JsonSerializable(explicitToJson: true)
class QuizExamAnswer{
  QuizExamAnswer({
    this.isCorrect,
    this.attempted,
  ...
  factory QuizExamAnswer.fromJson(Map<String, dynamic> json) =>
      _$QuizExamAnswerFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$QuizExamAnswerToJson(this);
}