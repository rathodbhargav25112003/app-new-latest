...
class NeetGroupSubscriptionList extends StatefulWidget {
  const NeetGroupSubscriptionList({super.key});

  @override
  State<NeetGroupSubscriptionList> createState() =>
      _NeetGroupSubscriptionListState();
  static Route<dynamic> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => const NeetGroupSubscriptionList(),
    );
  }
}

class _NeetGroupSubscriptionListState extends State<NeetGroupSubscriptionList>
                                  ...
                                  ? Padding(
                                      ...
                                      child: CustomDynamicHeightGridView(
                                        ...
                                        builder:
                                          ...
                                          return buildItem(context, store,
                                              index, loginStore);
                                        },
                                      ),
                                    )
