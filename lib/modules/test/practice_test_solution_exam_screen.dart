...
// Wave-2 post-attempt analytics panel — opens from the app-bar
// Insights icon. Bundles heatmap + time-pressure + calibration +
// cohort percentile + pattern summary + remediation CTA.
...
import 'package:shusruta_lms/modules/widgets/bottom_raise_query_window.dart' show CustomBottomRaiseQueryWindow;
...
class PracticeTestSolutionExamScreen extends StatefulWidget {
  ...
  @override
  State<PracticeTestSolutionExamScreen> createState() =>
      _PracticeTestSolutionExamScreenState();
...
class _PracticeTestSolutionExamScreenState
    extends State<PracticeTestSolutionExamScreen> {
  ...
  /// Wave-2 insights sheet — full-screen route hosting
  /// PostAttemptAnalyticsPanel. Hidden when userExamId isn't
  /// available (defensive — shouldn't happen on this screen).
  ...
  Future<void> _showNextQuestion() async {
    ...
    store.saveChangeExaplanation(context, {
      "question_id": filterTest?[_currentQuestionIndex].sId,
  ...
  Widget getExplanationText(BuildContext context) {
    ...
    for (String text in splittedText) {
      ...
      _quillController.document = Document.fromJson(
          filterTest![_currentQuestionIndex].isHighlight ?? false
...
$documentContent"""));
  ...
  Future<void> getCountReportPractice(context) async {
    final store = Provider.of<TestCategoryStore>(context, listen: false);
    await store.onGetReportPracticeCountApiCall(
        widget.userExamId ?? "", widget.type ?? "", false);
  }
  ...
  Map<String, int> calculateExamMetrics(List<TestData> questions) {
    ...
    for (var question in questions) {
      bool isAttempted = question.selectedOption != null &&
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Row(
              children: [
                ...
                // Wave-2 Insights button — opens the full-screen
                // PostAttemptAnalyticsPanel sheet.
                if ((widget.userExamId ?? '').isNotEmpty) ...[
                  IconButton(
                    icon: Icon(
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          margin: const EdgeInsets.only(
                              right: Dimensions.PADDING_SIZE_SMALL * 1.7),
                          alignment: Alignment.center,
                          decoration: BoxDecoration(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildScoreItem(
                        ...
                        color: Colors.green,
                        label:
                            '${calculateExamMetrics(filterTest ?? [])['attempted_correct']}',
                        label2: "",
                      ),
                      // Incorrect
                      _buildScoreItem(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      ListView.builder(
                        ...
                        itemCount: filterTest?[_currentQuestionIndex]
                            .optionsData
                            ?.length,
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String? correctPercentage =
                              testExamPaper?.correctPercentage;
                          ...
                          if (_selectedIndex >= 0 &&
                              _selectedIndex <
                                  (testExamPaper?.optionsData?.length ?? 0)) {
                            showTxt = ((testExamPaper?.correctOption ?? "") ==
                                    (testExamPaper?.optionsData?[index].value ??
                                        ""))
                                ? "Correct Answer"
                                : ((testExamPaper?.optionsData?[_selectedIndex]
                                                .value ??
                                            "") ==
                                        (testExamPaper
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(
                                        ...
                                        vertical:
                                            Dimensions.PADDING_SIZE_SMALL * 1.5,
                                      ),
                                      child: Row(
                                        crossAxisAlignment:
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            GestureDetector(
                                              ...
                                              child: const Icon(Icons.list_alt, size: 22, color: Colors.amber),
                                            ),
                                            const SizedBox(width: 10),
                  ...
                  children: [
                    Expanded(
                      child: CustomPreviewBox(
                        onTap: isprocess == true
                            ? null
                            : (firstQue ? null : _showPreviousQuestion),
                        text: "Previous",
                      ),
                    ),
                    const SizedBox(
          ...
          drawer: Drawer(
            ...
            child: QuestionPallet(widget.testExamPaper, widget.userExamId, null,
                widget.isPracticeExam, null),
          )),
    );
  }
        ...
        builder: (BuildContext context) {
          ...
          return Dialog(
            ...
            insetPadding: const EdgeInsets.symmetric(
                horizontal: 40), // Horizontal padding for better alignment
            child: StatefulBuilder(
              builder: (BuildContext context, StateSetter setModalState) {
                return Padding(
                  padding: const EdgeInsets.all(
                      16.0), // Added more padding for a spacious look
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: CustomButton(
                              onPressed: () {
                                Navigator.pop(context,
                                    currentFontSize); // Return the updated font size
                              },
                              buttonText: "Apply",
                              height: Dimensions.PADDING_SIZE_EXTRA_LARGE * 2,
                              radius: Dimensions.RADIUS_DEFAULT,
