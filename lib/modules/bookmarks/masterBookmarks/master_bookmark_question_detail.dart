...
/// MasterBookMarkQuestionDetailScreen — paginated review of master-catalog
/// bookmarked questions. Re-skinned with AppTokens; public surface (class,
/// const constructor, static [route] factory, state fields, and all
/// instance methods incl. [getExplanationText] / [getQuestionText] /
/// [_putBookMarkApiCall] / [deleteBookMarkApiCall] / [getQuestionLabel] /
/// [_showDialog] / [_getExplanationData] / [_showNotesDialog] /
/// [addNotes] / [_showBottomSheet]) is preserved exactly. The
/// [_showDialog] path uses [MockBottomRaiseQuery] from master reports.
class MasterBookMarkQuestionDetailScreen extends StatefulWidget {
  final List<SolutionReportsModel>? bookMarkQuestions;
  final int index;
  final String? examId;
  const MasterBookMarkQuestionDetailScreen(
      {super.key, this.bookMarkQuestions, this.examId, required this.index});

  @override
  State<MasterBookMarkQuestionDetailScreen> createState() =>
      _MasterBookMarkQuestionDetailScreenState();
  static Route<dynamic> route(RouteSettings routeSettings) {
    final arguments = routeSettings.arguments as Map<String, dynamic>;
    return CupertinoPageRoute(
      builder: (_) => MasterBookMarkQuestionDetailScreen(
...
class _MasterBookMarkQuestionDetailScreenState
    extends State<MasterBookMarkQuestionDetailScreen> {
